...
UsernameTextbox = pw.Textbox(pge, Position((120,550))*RATIO, 25*RATIO.y, colors=[COLOR_DARK_ALMOND,pge.Colors.ALMOND,pge.Colors.BLACK, pge.Colors.WHITE], font=PS16, text=f"{GD.username}", tip=("Username that will save score",PS14))
