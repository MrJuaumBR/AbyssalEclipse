...
GAME_SFX_SHIELD_OFF = pg.mixer.Sound(f"{GAME_PATH_SOUNDS}/shield-off.wav")
GAME_SFX_SHIELD_ON = pg.mixer.Sound(f"{GAME_PATH_SOUNDS}/shield-on.wav")
GAME_SFX_NUKE = pg.mixer.Sound(f"{GAME_PATH_SOUNDS}/nuke-explosion.wav")
